...
function Navbar() {
    ...
    return (
        <>
            ...
            >
                <div className="navbar bg-base-100 shadow-sm dark:bg-[#1D232A] dark:text-white bg-white">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow dark:bg-[#1D232A] dark:text-white bg-white"
                            >
                                {navItems}
                            </ul>
                        </div>
                    ...
                    <div className="navbar-end space-x-3">
                        <div className="navbar-center hidden lg:flex">
                            <ul className="menu menu-horizontal px-1 anchor_full">
                                {navItems}
                            </ul>
                        </div>
